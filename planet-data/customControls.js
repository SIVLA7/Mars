...
//////////////////////////////////////////////////////////////////////////////////
document.getElementById("services").addEventListener( 'mousedown', onDocumentMouseDown, false );
document.getElementById("services").addEventListener( 'mousemove', onDocumentMouseMove, false );
document.getElementById("services").addEventListener( 'mouseup', onDocumentMouseUp, false );
document.getElementById("services").addEventListener( 'touchstart', onDocumentTouchStart, false );
document.getElementById("services").addEventListener( 'touchmove', onDocumentTouchMove, false );
